  ...
  return (
    <div className="trades">
      <div className="common-pages trades">
        <h1 className="common-heading tradesHeading">Stock Trading Journal</h1>
        <h2 className='common-subheading tradesSubheading'>Enter Trade Details</h2>
        ...
        <table className="table">
          ...
          <tbody>
            <tr className="table-row">
              {trades.map(i => (
                <td className="table-data" scope='row' key={i.id}>
                  <td className="table-data" scope="row">{i.entryDate}</td>
                  <td className="table-data" scope="row">{i.symbol}</td>
                  <td className="table-data" scope="row">{i.shares}</td>
                  <td className="table-data" scope="row">{i.entryPrice}</td>
                  <td className="table-data" scope="row">{i.exitPrice}</td>
                  <td className="table-data" scope="row">{i.profitLoss}</td>
                </td>
              ))}
            </tr>
          </tbody>
